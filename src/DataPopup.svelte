    ...
    <div class="grid gap-4 modal-panel grid-rows-[minmax(0,_1fr)_min-content]">
        <FadedScroll bind:reachedBottom={hasScrolledToBottom}>
            <section class="text">
                ...
                <p>
                    We collect minimal Usage Data automatically while You are
                    using the Service.
                </p>
                ...
                <ul class="bulleted-list">
                    ...
                    <li>
                        Core Web Vitals (data about the site to understand the
                ...
                <p>
                    ...
                    personally identifiable information and is designed to
                    protect against spam and abuse. For more details about
                    Cloudflare Turnstile and its privacy practices, you can
                    refer to Cloudflare's own privacy policy.
                </p>
                ...
                <b
                    ...
                    companies or services. This excludes the required
                    third-party companies that Our Services uses to provide You
                    with a method of creating an account and loggin in.</b
                >
