...
>
    <div
        class="grid-rows-[minmax(0,_1fr)_min-content] grid gap-2 px-2 py-1 divide-y divide-white/10 w-full h-full overflow-hidden"
    >
        <!-- Faded scroll just for fanciness -->
        <FadedScroll>
            <ul class="flex flex-col gap-2 xs:gap-1 alternating-bg">
                <li class="flex flex-col gap-1 p-3 rounded-lg li-alternating">
                    <label
                        for="show-danger"
                    ...
                    >
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs text-white/50"
                                >Highlights the objects in the level that you
                                can collide with.</span
                            >
                        </div>
                        <span>
                            <ToggleSwitch
                ...
                <li class="flex flex-col gap-1 p-3 rounded-lg li-alternating">
                    ...
                    >
                        <div class="flex flex-col">
                            ...
                            <span class="text-xs text-white/50"
                                >Hide the text that appears when an object is
                                deleted</span
                            >
                        </div>
                        <span>
